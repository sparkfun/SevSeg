/*
 ...
 the display you have to call sevseg.DisplayNumber(#, decimalPlace) multiple times a second. Put this
 in the main loop.

 SparkFun has a large, 1" 7-segment display that has four digits. 
 Looking at the display like this: 8.8.8. pin 1 is on the lower row, starting from the left. 
...
void loop() {
  ...
  sevseg.DisplayNumber(deciSecond, 3); //(numberToDisplay, decimal point location)
